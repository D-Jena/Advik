				...
				<%@ include file="/WEB-INF/views/message.jsp"%>
					<div class="col-md-12">
						<form class="form-horizontal" method="POST" action="${contextPath}/system/setup/module/save" id="frmModule">
	                           ...
	                           <div class="form-group">
	                              ...
	                              <div class="col-md-9">
	                              	<div class="input-group">
	                                 	<input type="text" id="menuIcon" name="menuIcon" readonly value="${menu.menuIcon}" class="form-control form-control-sm" required style="height:32px!important">
                        	...
                        	<div class="col-md-3">
                        		<div class="form-group">
	                              ...
	                              <div class="col-md-12">
	                                 <input type="number" id="displayOrder" name="displayOrder" min="1" value="${menu.displayOrder}" maxlength="10"  class="form-control form-control-sm" required>
	                              </div>
                           		</div>
                        	</div>
                        	...
                        	<div class="col-md-2">
                        		 <div class="form-group">
	                              <label class="col-md-12 required text-center" for="isActive">Active Status</label>
	                              <div class="col-md-12">
	                                 <input type="checkbox" id="isActive" name="isActive" ${menu.isActive eq true ? 'checked' : ''} class="form-control form-control-sm" required
	                                 style="height:30px;">
	                              </div>
                           		</div>
                        	</div>
			 	 	  ...
			 	 	  <div class="col-sm-12 text-center mt-2">
			 	 		...
			 	 		<a href="${contextPath}/system/setup/module" class="btn btn-warning btn-sm">Cancel</a>
			 	 	  </div>
			 	 </div>
			 	 	 </form>
					</div> 
