	...
	<div class="panel-header bg-primary-gradient">
		<div class="page-inner py-4">
			<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
				<div>
					<h2 class="text-blue pb-2 fw-bold"><spring:message code="site.system.menu.add" /></h2>
				...
				<div class="ml-md-auto mb-4 py-2 py-md-0">
					...
					<a href="#" class="btn btn-sm btn-border btn-blue btn-round mr-2">/ <spring:message code="site.system.menu" /></a>
					<a href="#" class="btn btn-sm btn-border btn-blue btn-round mr-2">/ <spring:message code="site.system.menu.add" /></a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row mt-2">
			<div class="col-md-12">
			 <div class="card full-height">
			 	 ...
			 	 <div class="card-body">
			 	 	 <div class="row">
				<div class="alert alert-info">This page can be used only to add	a Submenu to a Module.</div>
						...
						<form class="form-horizontal" method="POST"
							...
							<div class="col-md-12">
									...
									<div class="form-group">
										...
										<div class="col-md-12">
											<input type="text" id="menuTextEN" name="menuTextEN"
												...
												value="${menu.menuTextEN}" class="form-control form-control-sm" maxlength="70"  required>
										</div>
									</div>
								</div>
									...
									<div class="form-group">
										...
										<div class="col-md-12">
											<input type="text" id="menuTextHI" name="menuTextHI"
												onchange="validateCharacterOnly(this.value);"
												value="${menu.menuTextHI}" class="form-control form-control-sm" maxlength="70"  required>
										</div>
									</div>
								</div>
	                           ...
	                           <div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-md-12">
											<input type="number" id="displayOrder" name="displayOrder"
												min="1" value="${menu.displayOrder}" maxlength="10"  class="form-control form-control-sm"
												required>
										</div>
									</div>
								</div>
								...
								<div class="col-md-2">
									<div class="form-group">
										<label class="col-md-12 text-center" for="isDisplay">Is
											Display</label>
										<div class="col-md-12">
											<input type="checkbox" id="isDisplay" name="isDisplay" style="height: 30px;"
								...
								<div class="col-md-2">
									<div class="form-group">
										<label class="col-md-12 text-center" for="isActive">Active
											Status</label>
										<div class="col-md-12">
											<input type="checkbox" id="isActive" name="isActive" style="height: 30px;"
								...
								<div class="col-md-2">
									<div class="form-group">
										...
										<div class="col-md-12">
											<select class="form-control form-control-sm" id="parentmenuId"
