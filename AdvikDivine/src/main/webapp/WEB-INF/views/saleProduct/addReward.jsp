		...
		<div class="panel-header bg-primary-gradient">
			<div class="page-inner py-4">
				<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
					<div>
						<h2 class="text-blue pb-2 fw-bold">Reward</h2>
					</div>
					<div class="ml-md-auto mb-4 py-2 py-md-0">
						...
						<a href="#" class="btn btn-sm btn-border btn-blue btn-round mr-2">/Add Reward</a>
					</div>
				</div>
			</div>
		</div>
									...
									<div class="row">
												<div class="col-md-3">
														<div class="form-group">
															<label class="col-sm-12 required" for="text">Reward Name :</label>
															<div class="col-sm-12">
																<input type="text" class="form-control AlphaNumericOnly" id="stateName" name="stateName">
												...
												<div class="col-md-3">
														<div class="form-group">
															<label class="col-sm-12 required" for="text">Reward Type:</label>
															<div class="col-sm-12">
												...
												<div class="col-md-3">
														<div class="form-group">
															<label class="col-sm-12 required" for="text">Reward Point :</label>
															<div class="col-sm-4">
