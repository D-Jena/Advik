                ...
                <div class="panel-header bg-primary-gradient">
                    <div class="page-inner py-5">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            <div>
                                <h2 class="text-white pb-2 fw-bold">Manage Sale</h2>
                            </div>
                            <div class="ml-md-auto py-2 py-md-0">
                                <a href="stateInit_dashboard.html" class="btn btn-white btn-border btn-round mr-2"><i
                                        class="fa fa-home"></i></a>
                                <a href="#" class="btn btn-secondary btn-round">/ Manage Sale</a>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-3">
											<div class="form-group">
												...
												<div class="col-sm-12">
													<input type="text" class="form-control NumbersOnly" placeHolder="Enter Mobile No. " id="ExCustMobile" onchange="checkSpaces(this)">
													<button class="btn btn-sm btn-primary form-control">Search Customer</button>
												</div>
											</div>
										</div>
										<div class="col-md-3">
											<div class="form-group">
												...
												<div class="col-sm-12">
													<button class="btn btn-sm btn-primary form-control">New Customer</button>
												</div>
											</div>
										</div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                              <div class="col-md-3">
												<div class="form-group">
													<label class="col-sm-12 required" for="text">Customer Name:</label>
													<div class="col-sm-12">
                                            ...
                                            <div class="col-md-3">
												<div class="form-group">
													<label class="col-sm-12 required" for="text">Whatsapp Mobile No :</label>
													<div class="col-sm-12">
