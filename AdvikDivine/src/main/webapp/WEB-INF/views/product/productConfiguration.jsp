                ...
                <div class="panel-header bg-primary-gradient">
                    <div class="page-inner py-5">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            <div>
                                <h2 class="text-white pb-2 fw-bold">Manage Configuration</h2>
                            </div>
                            <div class="ml-md-auto py-2 py-md-0">
                                <a href="stateInit_dashboard.html" class="btn btn-white btn-border btn-round mr-2"><i
                                        class="fa fa-home"></i></a>
                                <a href="#" class="btn btn-secondary btn-round">/ Manage Configuration</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="card full-height">
                                <div class="card-header">
                                    ...
                                    <h4 class="card-title">Product Configuration</h4>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="col-md-12">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-3">
												<div class="form-group">
													<label class="col-sm-12 required" for="text">Enter Size:</label>
													<div class="col-sm-12">
                                              ...
                                              <div class="col-md-3">
												<div class="form-group">
													<label class="col-sm-12 required" for="text">Enter Colors:</label>
													<div class="col-sm-12">
														<input type="text" class="form-control AlphaNumericOnly" id="villageName" name="villageName" value="${vm.villageName}"  onchange="checkSpaces(this)" required maxlength="50">
													</div>
												</div>
                                            ...
                                            <div class="col-md-3">
												<div class="form-group">
													<label class="col-sm-12 required" for="text">Any Extra  :</label>
													<div class="col-sm-12">
