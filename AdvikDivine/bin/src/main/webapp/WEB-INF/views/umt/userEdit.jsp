	...
	<div class="panel-header bg-primary-gradient">
		<div class="page-inner py-4">
			<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
				<div>
					<h2 class="text-blue pb-2 fw-bold">Edit User</h2>
				...
				<div class="ml-md-auto mb-4 py-2 py-md-0">
					...
					<a href="#" class="btn btn-sm btn-border btn-blue btn-round mr-2">/Edit User</a>
				</div>
			</div>
		</div>
	</div>
												...
												<table class="table table-bordered table-striped mb-none"  id="tableId1">
													...
													<c:forEach items="${userRoleHcMapList}" var="userRoleHcMapList" varStatus="index"> 
														<tr>
															...
															<td>
																<select class="form-control form-control-sm" name="isPrimary[]" id="isPrimary${index.count}">
																	<option value="">--Select--</option>
															...
															<td>
																<select class="form-control form-control-sm" name="roleName[]" id="roleName${index.count}" data-plugin-selectTwo onchange="checkDuplicate(${index.count},this.value)">
																	<option value="">--Select--</option>
															...
															<td>
																<select class="form-control form-control-sm" name="status[]" id="status${index.count}" >
