		...
		<div class="page-inner py-4">
			<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
				...
				<div class="ml-md-auto mb-4 py-2 py-md-0">
					...
					<a href="#" class="btn btn-sm btn-border btn-blue btn-round mr-2">/ View User</a>
				</div>
			</div>
		</div>
	</div>
						...
						<form class="form-horizontal" action="#" method="POST" id="userForm">
									...
									<div class="row">
										<div class="col-md-12">
											...
											<div class="col-md-3">
												<div class="form-group">
													<label class="col-md-12 required" for="complaintName">User Id</label>
													<div id="hideUserId"> 
													<div class="col-md-12">
														<input type="text" id="username" name="username" value="${userDetails.userName}" class="form-control" required  readonly onchange="userNameValidation();" maxlength="60">
													</div>
													</div>
												</div>
											</div>
											<div class="col-md-3">
												<div class="form-group">
													<label class="col-md-12 required" for="complaintName">First Name</label>
													<div class="col-md-12">
														<input type="text" id="firstname" name="firstname" value="${userDetails.firstName}" class="form-control"  readonly required maxlength="100">
													</div>
												</div>
											</div>
											<div class="col-md-3">
												<div class="form-group">
													<label class="col-md-12 required" for="complaintAge">Last Name</label>
													<div class="col-md-12">
														<input type="text" id="lastname" name="lastname" value="${userDetails.lastName}" class="form-control" required readonly maxlength="100">
													</div>
												</div>
											</div>
											</div>
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<div class="col-md-12">
														<input type="text" name="userMobile" id="userMobile" class="form-control" maxlength="10"  value="${userDetails.mobile}" readonly required>
													</div>
												</div>
											</div>
											<div class="col-md-3">
												<div class="form-group">
													...
													<div class="col-md-12">
														<input type="text" name="userEmail" id="userEmail" class="form-control"  value="${userDetails.email}" required  readonly maxlength="150">  
													</div>
												</div>
											</div> 
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<div class="col-md-12">
														<input type="text" name="designation" id="designation" class="form-control"  value="${userDetails.designation}" required readonly maxlength="150">  
													</div>
												</div>
											</div> 
												...
												<table class="table table-bordered table-striped mb-none"  id="tableId1">
													...
													<c:forEach items="${userRoleHcMapList}" var="userRoleHcMapList" varStatus="index"> 
														<tr>
															...
															<td>
																<select class="form-control" name="isPrimary[]" id="isPrimary${index.count}" disabled="disabled">
																	<option value="">--Select--</option>
															...
															<td>
																<select class="form-control" name="roleName[]" disabled="disabled" id="roleName${index.count}" data-plugin-selectTwo onchange="checkDuplicate(${index.count},this.value)">
																	<option value="">--Select--</option>
															...
															<td>
																<select class="form-control" name="status[]" disabled="disabled" id="status${index.count}" >
									...
									<a
								href="${contextPath}/umt/user/list"
										type="button" class="btn btn-warning">Back</a>
								</div>
								</form>
					</div> 
				</div>
