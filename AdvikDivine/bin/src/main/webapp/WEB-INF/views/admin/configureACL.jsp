		...
		<div class="page-inner py-4">
			<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
				...
				<div class="ml-md-auto mb-4 py-2 py-md-0">
					...
					<a href="#" class="btn btn-sm btn-border btn-blue btn-round mr-2">/ <spring:message code="site.admin.acl.configure"/></a>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="col-md-12">
				<div class="card full-height">
					<div class="card-header">
						...
						<h4 class="card-title"><spring:message code="site.admin.acl.configure"/></h4>
					</div>
					<div class="card-body">
					<div class="row">
					<%@ include file="/WEB-INF/views/message.jsp"%>
                        ...
                        <div class="col-md-4">
                           <div class="form-group">
                              <label class="col-md-12 required" for="userName"><spring:message code="site.admin.user.id"></spring:message></label>
                              <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                           <div class="form-group">
                              <label class="col-md-12 required" for="roleId"><spring:message code="site.admin.acl.role"></spring:message></label>
                              <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                           <div class="form-group">
                              <label class="col-md-12 required" for="accessLevel"><spring:message code="site.admin.acl.level"></spring:message></label>
                              <div class="col-md-12">
