		...
		<div class="page-inner py-4">
			<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
				...
				<div class="ml-md-auto mb-4 py-2 py-md-0">
					...
					<a href="#" class="btn btn-sm btn-border btn-blue btn-round mr-2">/ Role Access to Levels</a>
				</div>
			</div>
		</div>
	</div>
						...
						<%@ include file="/WEB-INF/views/message.jsp"%>
							<div class="col-md-12">
								<form class="form-horizontal" action="${contextPath}/admin/role/roleLevelMap/addNupdate" method="POST" id="userForm">
									...
									<label style=" font-size: 15px !important;"><b>Role :-</b> <span style="font-style: oblique; color: #712808;font-weight: bold;">${roleData.displayName}</span> 
                                        </label>
										<div class="col-sm-12">
											<div>
