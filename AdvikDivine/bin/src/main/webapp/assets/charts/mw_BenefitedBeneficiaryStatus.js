function getBenifciaryMonthlyStatus(roleLevel,levelId)
		{
			$.ajax({
				type : "GET",
				url :  window.ctxPath + '/dashboard/getBenifciaryMonthlyStatus',
				dataType : "json",
				data : {
					"roleLevel" : roleLevel,
					"levelId" : levelId,
				...
				success : function(response) {
					...
					$.each(response.data, function(i, item){
						...
						array.push(obj);
							...
							var chart = am4core.create("mw_BenefitedBeneficiaryStatus", am4charts.XYChart);
